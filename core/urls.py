...
urlpatterns = [
    ...
    path('gestao-categorias.html', views.gestao_categorias_view),
    ...
    path('historico-entregas.html', views.historico_entregas_view),
    ...
    path('api/beneficiarios/<int:pk>/entregas', views.api_beneficiario_entregas),
