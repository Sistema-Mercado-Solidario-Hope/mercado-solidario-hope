...
urlpatterns = [
    ...
    path('vitrineNecessidade.html', views.vitrine_view),
    ...
    path('gestãoDeEstoqueHome.html', views.gestao_estoque_view),
    path('visaoGeralEstoque.html', views.visao_geral_view),
    path('inserirEstoque.html', views.inserir_estoque_view),
    path('validar-intencoes.html', views.validar_intencoes_view),
    path('frenteCaixa.html', views.frente_caixa_view),
    path('cadastro-familia.html', views.cadastro_familia_view),
    path('familia-listagem.html', views.familia_listagem_view),
    path('cadastrodeproduto.html', views.cadastro_produto_view),
